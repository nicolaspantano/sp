...
namespace WindowsForms.SP
{
    public partial class SegundoParcial : Form
    {
        ...
        {
            MessageBox.Show("Pantano Nicolas");
        }
        ...
        {
            bool todoOK = Ticketeadora.ImprimirTicket(c_gomas.PrecioTotal);//Reemplazar por la llamada al método de clase ImprimirTicket
        ...
        private void btnVerLog_Click(object sender, EventArgs e)
        {
            ...
            this.openFileDialog1.Filter = ".log";
            ...
            if (rta == System.Windows.Forms.DialogResult.OK)
            {
                ...
                StreamReader reader = new StreamReader(this.openFileDialog1.OpenFile());                                                                    
        ...
        private void btnPunto6_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.da.SelectCommand.Connection = this.cn;
                this.da.SelectCommand = new SqlCommand("select * from dbo.utiles");                
