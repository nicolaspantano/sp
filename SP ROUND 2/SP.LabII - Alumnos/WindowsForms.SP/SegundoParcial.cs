...
namespace WindowsForms.SP
{
    public partial class SegundoParcial : Form
    {
        ...
        private void btnPunto4_Click(object sender, EventArgs e)
        {
            ...
            this.c_gomas.EventoPrecio += new Cartuchera<Goma>.EventoPrecioDelegate(c_gomas_EventoPrecio);
        ...
        private void btnVerLog_Click(object sender, EventArgs e)
        {
            ...
            if (rta == System.Windows.Forms.DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    txtVisorTickets.Text = reader.ReadToEnd();
                    reader.Close();
                }
                catch (Exception ex)
                {
        ...
        private void btnPunto9_Click(object sender, EventArgs e)
        {
            ...
            this.da.UpdateCommand.Parameters.Add("@p3", SqlDbType.VarChar, 50, "tipo");
            //Modificar el ultimo registro del dataTable
            this.dt.Rows[this.dt.Rows.Count - 1]["marca"] = "barriliro";
